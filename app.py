...
def index():
    ...
    if request.method == 'POST':
        ...
        return render_template('index.html', villages=villages, longitudespass=longitudespass, latitudespass=latitudespass)
...
def update(id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return redirect('/')  # after update, redirect back to homepage to see updated village
        except:
